...
test('Discord attachment/embed image URLs dedupe via proxy normalization', () => {
  const cdnUrl = 'https://cdn.discordapp.com/attachments/123/456/image.png?ex=abc&is=def&hm=ghi';
  const proxyUrl = 'https://images-ext-1.discordapp.net/external/token/https/cdn.discordapp.com/attachments/123/456/image.png?format=webp&width=400&height=300';
